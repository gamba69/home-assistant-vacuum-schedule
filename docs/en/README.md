...
For an upgrade from 0.12.61, install 0.13.3, restart Home Assistant, add **Vacuum Schedule**, select the same vacuum and confirm migration of the detected legacy entry.
